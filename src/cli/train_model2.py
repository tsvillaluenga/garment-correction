#!/usr/bin/env python3
"""
Training script for Model 2: Segmentation for still images.
"""
import argparse
import logging
import sys
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train Model 2: Segmentation for still images")
...
def main():
    ...
    save_config_file(config, config_save_path, "Model 2 - Still Segmentation")
    ...
    try:
        history.plot_curves(plot_path, "Model 2 - Still Segmentation Training Progress")
